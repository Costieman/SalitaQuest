...
for (const marker of [
  'const TARGET = "./src/features/economy/economy-tracking-phase6-v1.js?v=sandbox-deletion-pass-1"',
...
const tabsIndex = loader.indexOf('avatar-collection-tabs-phase6-1-v1.js?v=sandbox-deletion-pass-1');
...
if (loader.includes('"./economy-tracking-phase6-v1.js?v=sandbox-deletion-pass-1"')) fail("Current loader still targets the root compatibility URL");
for (const marker of [
