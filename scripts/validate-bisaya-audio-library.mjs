...
check(serviceWorker.includes('const PREVIOUS_CACHE_NAME = "salita-quest-v5-6-12-avatar-collection-summary-extraction-r65"'),
  "service worker no longer records the pre-modular persistent-navigation boundary");
check(serviceWorker.includes('const CACHE_NAME = "salita-quest-v5-6-13-collection-key-translation-hotfix-extraction-r66"'),
