...
check(serviceWorker.includes('const PREVIOUS_CACHE_NAME = "salita-quest-v5-6-11-avatar-collection-tabs-extraction-r64"'),
  "service worker no longer records the pre-modular persistent-navigation boundary");
check(serviceWorker.includes('const CACHE_NAME = "salita-quest-v5-6-12-avatar-collection-summary-extraction-r65"'),
