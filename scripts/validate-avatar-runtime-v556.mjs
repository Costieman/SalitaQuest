...
check(sources.worker.includes('PREVIOUS_CACHE_NAME = "salita-quest-v5-6-11-avatar-collection-tabs-extraction-r64"'), "Service worker records the pre-modular cache boundary");
check(sources.worker.includes('CACHE_NAME = "salita-quest-v5-6-12-avatar-collection-summary-extraction-r65"'), "Service-worker cache revision is the modular-bootstrap release");
