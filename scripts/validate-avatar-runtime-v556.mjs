...
check(sources.worker.includes('PREVIOUS_CACHE_NAME = "salita-quest-v5-6-17-coin-shop-badge-adapter-extraction-r70"'), "Service worker records the pre-modular cache boundary");
check(sources.worker.includes('CACHE_NAME = "salita-quest-v5-6-18-incorrect-order-feedback-adapter-extraction-r71"'), "Service-worker cache revision is the modular-bootstrap release");
