...
check(sources.worker.includes('PREVIOUS_CACHE_NAME = "salita-quest-v5-6-2-pronunciation-module-extraction-r55"'), "Service worker records the pre-modular cache boundary");
check(sources.worker.includes('CACHE_NAME = "salita-quest-v5-6-3-desktop-shell-extraction-r56"'), "Service-worker cache revision is the modular-bootstrap release");
