...
check(sources.worker.includes('PREVIOUS_CACHE_NAME = "salita-quest-v5-6-4-progress-rail-extraction-r57"'), "Service worker records the pre-modular cache boundary");
check(sources.worker.includes('CACHE_NAME = "salita-quest-v5-6-5-avatar-data-migration-extraction-r58"'), "Service-worker cache revision is the modular-bootstrap release");
