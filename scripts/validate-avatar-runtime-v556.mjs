...
check(sources.worker.includes('PREVIOUS_CACHE_NAME = "salita-quest-v5-6-7-achievement-sharing-router-extraction-r60"'), "Service worker records the pre-modular cache boundary");
check(sources.worker.includes('CACHE_NAME = "salita-quest-v5-6-8-home-reward-coordinator-extraction-r61"'), "Service-worker cache revision is the modular-bootstrap release");
