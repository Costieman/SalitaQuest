...
if (!index.includes('src="src/features/avatar/avatar-catalogue.js?v=sandbox-deletion-pass-1"')) {
...
if (!profileApp.includes("./src/features/avatar/avatar-catalogue.js?v=sandbox-deletion-pass-1") && !profileApp.includes("./src/features/avatar/avatar-catalogue.js?v=sandbox-deletion-pass-1")) {
