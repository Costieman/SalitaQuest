...
if (previousCache !== "salita-quest-v5-6-18-incorrect-order-feedback-adapter-extraction-r71") fail("Previous cache is not r68");
if (currentCache !== "salita-quest-v5-6-19-long-term-badge-adapter-extraction-r72") fail("Current cache is not r69");
