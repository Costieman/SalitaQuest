...
if (previousCache !== "salita-quest-v5-6-15-level-avatar-rewards-extraction-r68") fail("Previous cache is not r68");
if (currentCache !== "salita-quest-v5-6-16-avatar-hotfix-adapters-extraction-r69") fail("Current cache is not r69");
