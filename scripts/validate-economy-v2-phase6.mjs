...
if (!loader.includes("economy-tracking-phase6-v1.css?v=sandbox-deletion-pass-1")) fail("Phase 6 stylesheet is not loaded.");
if (!loader.includes("src/features/economy/economy-tracking-phase6-v1.js?v=sandbox-deletion-pass-1")) fail("Extracted Phase 6 runtime is not loaded.");
