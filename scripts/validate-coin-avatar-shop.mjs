...
const required = [
  ...
  [shop,"coin-avatar-shop-reveal-v1.js?v=sandbox-deletion-pass-1"],
  [shop,"coin-avatar-shop-reveal-v1.css?v=sandbox-deletion-pass-1"],
  ...
  [topbar,'coin-avatar-reveal-rarity-v1.css?v=sandbox-deletion-pass-1'],
  [topbar,'coin-testing-grant-100k-v1.js?v=sandbox-deletion-pass-1'],
