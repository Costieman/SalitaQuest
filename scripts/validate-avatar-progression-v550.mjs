...
if (!serviceWorker.includes('const PREVIOUS_CACHE_NAME = "salita-quest-v5-6-22-avatar-sharing-bridge-extraction-r75"')) fail("Service worker does not retain the pre-modular release boundary");
if (!serviceWorker.includes('const CACHE_NAME = "salita-quest-v5-6-23-badge-catalogue-extraction-r76"')) fail("Service worker cache version is not the modular-bootstrap release");
