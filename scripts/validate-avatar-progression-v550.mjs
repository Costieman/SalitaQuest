...
if (!serviceWorker.includes('const PREVIOUS_CACHE_NAME = "salita-quest-v5-6-7-achievement-sharing-router-extraction-r60"')) fail("Service worker does not retain the pre-modular release boundary");
if (!serviceWorker.includes('const CACHE_NAME = "salita-quest-v5-6-8-home-reward-coordinator-extraction-r61"')) fail("Service worker cache version is not the modular-bootstrap release");
