...
if (!loader.includes('const SHARING_VERSION = "5.5.13.1"')) fail("Shared avatar loader does not version the Facebook card-link sharing runtime");
...
console.log(`Avatar progression integration validation passed: ${model.catalogue.length} direct canonical avatars, four-slot Avatar Case, persistent labelled navigation, visible-link Facebook sharing, compatibility-only bridge, preserved learner state and r52 offline delivery.`);