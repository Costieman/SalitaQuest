...
if (!serviceWorker.includes('const PREVIOUS_CACHE_NAME = "salita-quest-v5-6-16-avatar-hotfix-adapters-extraction-r69"')) fail("Service worker does not retain the pre-modular release boundary");
if (!serviceWorker.includes('const CACHE_NAME = "salita-quest-v5-6-17-coin-shop-badge-adapter-extraction-r70"')) fail("Service worker cache version is not the modular-bootstrap release");
