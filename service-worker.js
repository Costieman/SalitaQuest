const CACHE_NAME = "salita-quest-v5-4-bisaya-name-village-r8";
const STATIC_FILES = [
  ...
  "./style.css", "./app.js", "./languages/cebuano/course.json", "./languages/cebuano/README.md", "./languages/cebuano/modules/manifest.json", "./languages/cebuano/modules/introductions.json", "./manifest.webmanifest", "./icons/icon-192.png", "./icons/icon-512.png",
