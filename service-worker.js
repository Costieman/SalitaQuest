const CACHE_NAME = "salita-quest-v5-4-bisaya-foundation-r7";
const STATIC_FILES = [
  ...
  "./style.css", "./app.js", "./languages/cebuano/course.json", "./languages/cebuano/README.md", "./manifest.webmanifest", "./icons/icon-192.png", "./icons/icon-512.png",
